  ...
  plans: [
    ...
    },
    {
      ...
      features: [
        ...
        "Export vidéo 4K",
        "Traitement vidéo accéléré",
        "Génération vidéo étendue avec Avatar IV",
        "5× plus de quota de génération IA",
        "5 jumeaux numériques personnalisés (Custom Digital Twins)",
        "Édition et relecture des scripts de traduction",
        "Vidéo interactive (quiz, liens cliquables, scénarios à branches)",
        "Intégrations n8n, Make, HubSpot et Zapier",
      ],
    },
    {
      nom: "Enterprise",
      ...
      cible: "Production vidéo IA sur mesure, qualité studio",
      features: [
        "Vidéos illimitées, durée maximale levée",
        "Traitement vidéo prioritaire",
        "Gestion multi-espaces de travail",
        "Sièges de relecture dédiés à la traduction vidéo",
        "Sécurité et confidentialité de niveau entreprise",
        "Provisioning utilisateurs SCIM, authentification SSO",
      ],
    },
  ],
  alternatives: [
