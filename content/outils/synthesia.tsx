...
export const synthesiaFiche: FicheData = {
  ...
  plans: [
    ...
    },
    {
      nom: "Starter",
      prix: "12 €/mois",
      prixSub: "Facturation annuelle · 19 €/mois en mensuel · 14 500 crédits/an inclus",
      ...
      features: [
        ...
        "Plus de 125 avatars IA de Synthesia",
        "Avatars représentant votre marque",
        "Support par chat / e-mail",
      ],
    },
    {
      nom: "Creator",
      prix: "49 €/mois",
      prixSub: "Facturation annuelle · 79 €/mois en mensuel · Plan populaire · 44 000 crédits/an inclus",
      cible: "Créateurs réguliers",
      features: [
        "Tout Starter inclus",
        "5 avatars personnels",
        "Doublage IA",
        "Pages vidéo personnalisables",
        "Accès API",
        "Plusieurs avatars par scène",
        "Vidéos interactives",
        "1 éditeur et 5 invités",
        "Plus de 180 avatars IA de Synthesia",
        "Assistance prioritaire par chat / e-mail",
      ],
    },
    {
      nom: "Enterprise",
      ...
      features: [
        ...
        "Plus de 230 avatars IA libres de droits",
        "Nombre illimité d'avatars personnels",
        "SAML/SSO",
        "Collaboration en temps réel",
        "Kits de marque · Export SCORM",
        "Doublage IA (extension payante)",
      ],
    },
  ],
  alternatives: [
