...
export const veedFiche: FicheData = {
  ...
  verdict30s: [
    ...
    },
    {
      question: "Combien ?",
      answer:
        "Plan Free (0 €) avec watermark-free exports limités et 2 minutes/mois. Lite à 10,75 €/mois par user (annuel, 129 €/an) pour des vidéos sociales avec IA sans watermark. Pro (populaire) à 23,17 €/mois par user (annuel, 278 €/an) pour du pro-level. Business à 37,33 €/mois par user (annuel, 448 €/an) avec Project Analytics. Enterprise sur devis. Facturation EUR.",
    },
    {
  ...
  plans: [
    {
      ...
      features: [
        "Watermark-Free Exports (limités)",
        "2 minutes/mois",
    ...
    },
    {
      nom: "Lite",
      prix: "10,75 €/mois",
      prixSub: "Par user · facturation annuelle (129 €/an)",
      cible: "Créateurs occasionnels",
      features: [
        "Watermark-free social videos avec IA",
        "Crédits supplémentaires pour exports",
        "Accès aux outils IA de base",
      ],
    },
    {
      nom: "Pro",
      prix: "23,17 €/mois",
      prixSub: "Par user · facturation annuelle (278 €/an) · Populaire",
      cible: "Créateurs réguliers",
      features: [
        "Vidéos on-brand pro-level avec IA",
        "Jusqu'à 10 min/mo avec crédits",
        "Bibliothèques d'images et vidéos IA étendues",
        "Basic Characters",
      ],
    },
    {
      nom: "Business",
      prix: "37,33 €/mois",
      prixSub: "Par user · facturation annuelle (448 €/an)",
