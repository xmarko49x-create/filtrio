  ...
  plans: [
    ...
    },
    {
      ...
      features: [
        ...
        "Magic Clips et notes d'épisode · publication directe sur YouTube et annuaires podcast",
      ],
    },
    {
      nom: "Live",
    ...
    },
    {
      ...
      features: [
        ...
        "Outil de capture de leads · formulaire d'inscription personnalisé",
        "Emails de rappel et relances automatisés",
      ],
    },
    {
      nom: "Business",
      ...
      features: [
        ...
        "Rôles personnalisés · édition collaborative",
        "Accès API · intégration Salesforce",
        "Support prioritaire 24/7 · accompagnement à la prise en main",
        "Sécurité de niveau entreprise (SSO, SOC2, ISO 27001)",
      ],
    },
  ],
  alternatives: [
