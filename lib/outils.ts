...
export const OUTILS: Outil[] = [
  {
    ...
    category: "shorts",
    priceFrom: "À partir de 12 €/mois (annuel)",
  ...
  },
  {
    ...
    tagline: "Création vidéo IA premium",
    category: "generation-video",
    priceFrom: "À partir de 12 $/mois",
    freeTier: "Allocation gratuite unique (125 crédits)",
  ...
  },
  {
    ...
    score: 8.3,
    color: "teal",
    tagline: "Voix off, doublage, clonage vocal",
    category: "voix-ia",
  ...
  },
  {
    ...
    freeTier: "Plan gratuit (80 crédits/mois)",
